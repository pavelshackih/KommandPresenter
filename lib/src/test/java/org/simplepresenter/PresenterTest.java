...
public class PresenterTest {
    ...
    public void testProgressCommand1() {
        ...
        expected.add(new SimpleDataViewCommand("test1"));
        expected.add(new SimpleDataViewCommand("test2"));
        expected.add(ProgressViewCommand.INSTANCE);

        presenter.applyViewState(new SimpleDataViewCommand("test1"));
        presenter.applyViewState(ProgressViewCommand.INSTANCE);
        presenter.applyViewState(new SimpleDataViewCommand("test2"));
        presenter.applyViewState(ProgressViewCommand.INSTANCE);
    ...
    public void testProgressCommand2() {
        ...
        expected.add(new SimpleDataViewCommand("test1"));
        expected.add(new SimpleDataViewCommand("test2"));
        expected.add(new SimpleDataViewCommand("test3"));

        presenter.applyViewState(new SimpleDataViewCommand("test1"));
        presenter.applyViewState(ProgressViewCommand.INSTANCE);
        presenter.applyViewState(new SimpleDataViewCommand("test2"));
        presenter.applyViewState(ProgressViewCommand.INSTANCE);
        presenter.applyViewState(new SimpleDataViewCommand("test3"));
    ...
    public void testOneTimeCommand() {
        ...
        view.getPresenter().applyViewState(new SimpleDataViewCommand("test1"));
